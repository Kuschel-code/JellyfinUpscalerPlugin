...
[private security advisory](https://github.com/Kuschel-code/JellyfinUpscalerPlugin/security/advisories/new),
which is the one channel here that is not publicly readable. Ordinary conduct
concerns can also be raised in
