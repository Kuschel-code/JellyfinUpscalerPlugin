...
*   **Seamless Player Integration**: A dedicated "AI" button in the Jellyfin player allows control during playback.

## 🏁 Quick Start

1.  **[🚀 Installation](Installation)**: Install the plugin via the official repository.
2.  **[🎨 AI Models](AI-Models)**: Upload ONNX models to your plugin directory.
3.  **[⚙️ Configuration](Configuration)**: Run the benchmark in the Dashboard to optimize your system.
4.  **Enjoy**: Start playback and activate AI enhancement via the player button.
