...
const i18n = {
    en: {
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.4.0", date: "Mar 2026", type: "Feature", items: ["NEW: Multi-Frame Video Super-Resolution — 5-frame sliding window for dramatically better batch upscaling quality", "NEW: EDVR-M x4 model — uses temporal information across frames for superior results", "NEW: /upscale-video-chunk endpoint for multi-frame inference pipeline", "NEW: Auto-detection of multi-frame models via input_frames metadata", "NEW: Sequential processing with boundary frame padding (handles 1-frame to N-frame videos)", "NEW: ONNX conversion tool for PyTorch → ONNX model export (docker-ai-service/tools/)"] },
    ...
    de: {
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.4.0", date: "Mär 2026", type: "Feature", items: ["NEU: Multi-Frame Video Super-Resolution — 5-Frame Sliding Window für deutlich bessere Batch-Upscaling-Qualität", "NEU: EDVR-M x4 Modell — nutzt temporale Information über Frames für überlegene Ergebnisse", "NEU: /upscale-video-chunk Endpoint für Multi-Frame Inferenz-Pipeline", "NEU: Automatische Erkennung von Multi-Frame Modellen via input_frames Metadaten", "NEU: Sequenzielle Verarbeitung mit Boundary-Frame-Padding", "NEU: ONNX Konvertierungstool für PyTorch → ONNX Export"] },
    ...
    fr: {
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.4.0", date: "Mar 2026", type: "Feature", items: ["NOUVEAU: Super-résolution vidéo multi-trame — fenêtre glissante de 5 trames", "NOUVEAU: Modèle EDVR-M x4 — utilise l'information temporelle entre les trames", "NOUVEAU: Endpoint /upscale-video-chunk pour pipeline d'inférence multi-trame", "NOUVEAU: Détection automatique des modèles multi-trame", "NOUVEAU: Traitement séquentiel avec padding aux limites", "NOUVEAU: Outil de conversion ONNX pour export PyTorch → ONNX"] },
