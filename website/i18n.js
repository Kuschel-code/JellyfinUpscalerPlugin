...
const i18n = {
    en: {
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.4.0", date: "Mar 2026", type: "Major", items: ["NEW: Multi-Frame Video SR — 5-frame sliding window with EDVR-M, RealBasicVSR, AnimeSR v2", "NEW: Intelligent auto-model selection per video (anime/live-action, resolution, batch/real-time)", "NEW: Image upscaling for posters, backdrops, thumbnails, logos, banners", "NEW: Scheduled task 'Scan & Upscale Library Images' (weekly Sunday 4 AM)", "NEW: POST /upscale-images/{itemId} for batch image upscaling", "NEW: GET /recommend-model API endpoint for model recommendations", "NEW: ONNX conversion tool for EDVR-M, RealBasicVSR, AnimeSR (PyTorch → ONNX)", "FIX: Socket exhaustion from per-frame HttpClient in multi-frame processing", "FIX: Window frame count for even inputFrames values", "FIX: Edge tile ONNX shape error when one dimension < tile_size"] },
    ...
    de: {
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.4.0", date: "Mär 2026", type: "Major", items: ["NEU: Multi-Frame Video SR — 5-Frame Sliding Window mit EDVR-M, RealBasicVSR, AnimeSR v2", "NEU: Intelligente Auto-Modellauswahl pro Video (Anime/Live-Action, Auflösung, Batch/Echtzeit)", "NEU: Bild-Upscaling für Poster, Hintergründe, Thumbnails, Logos, Banner", "NEU: Geplante Aufgabe 'Bibliotheksbilder upscalen' (wöchentlich Sonntag 4 Uhr)", "NEU: POST /upscale-images/{itemId} für Batch-Bild-Upscaling", "NEU: GET /recommend-model API-Endpoint für Modellempfehlungen", "NEU: ONNX Konvertierungstool für EDVR-M, RealBasicVSR, AnimeSR", "FIX: Socket-Erschöpfung durch HttpClient pro Frame behoben", "FIX: Fenster-Frame-Anzahl für gerade inputFrames-Werte korrigiert", "FIX: Edge-Tile ONNX Shape-Fehler behoben"] },
    ...
    fr: {
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.4.0", date: "Mar 2026", type: "Major", items: ["NOUVEAU: SR vidéo multi-trame — fenêtre glissante avec EDVR-M, RealBasicVSR, AnimeSR v2", "NOUVEAU: Sélection automatique intelligente du modèle par vidéo (anime/live-action, résolution)", "NOUVEAU: Upscaling d'images pour affiches, arrière-plans, miniatures, logos, bannières", "NOUVEAU: Tâche planifiée 'Upscaler les images de la bibliothèque' (dimanche 4h)", "NOUVEAU: POST /upscale-images/{itemId} pour upscaling d'images par lot", "NOUVEAU: GET /recommend-model pour recommandations de modèles", "NOUVEAU: Outil de conversion ONNX pour EDVR-M, RealBasicVSR, AnimeSR", "CORR: Épuisement des sockets HttpClient dans le traitement multi-trame", "CORR: Comptage de trames pour valeurs inputFrames paires", "CORR: Erreur de forme ONNX pour les tuiles en bordure"] },
