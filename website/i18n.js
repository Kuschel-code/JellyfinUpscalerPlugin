...
const i18n = {
    en: {
        ...
        hero: {
            badge: "v1.5.4.0 — Multi-Frame Video SR",
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.4.0", date: "Mar 2026", type: "Major", items: ["NEW: Multi-Frame Video SR — 5-frame sliding window with EDVR-M, RealBasicVSR, AnimeSR v2", "NEW: Intelligent auto-model selection per video (anime/live-action, resolution, batch/real-time)", "NEW: Image upscaling for posters, backdrops, thumbnails, logos, banners", "NEW: Priority processing queue with pause/resume, persistence, priority 1-10", "NEW: Prometheus metrics endpoint (/metrics) — jobs, failures, frames, timing per model", "NEW: Circuit breaker pattern — auto-opens after consecutive failures, resets after timeout", "NEW: Detailed health endpoint (/health/detailed) with GPU health + circuit breaker state", "NEW: Model auto-management — disk usage tracking, LRU cleanup of unused models", "NEW: Webhook notifications — HTTP POST on job complete/failure", "NEW: Model fallback chain — comma-separated models, tries next on failure", "NEW: 20+ new config options (queue, webhooks, health, model management, filtering)", "FIX: processing_count going negative on semaphore timeout", "FIX: Blend weight normalization using actual content size", "FIX: Real-time model selection inverted (2x for real-time, 4x for batch)", "FIX: Socket exhaustion from per-frame HttpClient in multi-frame processing"] },
    ...
    de: {
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.4.0", date: "Mär 2026", type: "Major", items: ["NEU: Multi-Frame Video SR — 5-Frame Sliding Window mit EDVR-M, RealBasicVSR, AnimeSR v2", "NEU: Intelligente Auto-Modellauswahl pro Video (Anime/Live-Action, Auflösung, Batch/Echtzeit)", "NEU: Bild-Upscaling für Poster, Hintergründe, Thumbnails, Logos, Banner", "NEU: Prioritäts-Verarbeitungswarteschlange mit Pause/Fortsetzen, Persistenz, Priorität 1-10", "NEU: Prometheus Metriken-Endpunkt (/metrics) — Jobs, Fehler, Frames, Timing pro Modell", "NEU: Circuit Breaker — öffnet automatisch nach aufeinanderfolgenden Fehlern", "NEU: Detaillierter Health-Endpunkt (/health/detailed) mit GPU-Zustand + Circuit Breaker Status", "NEU: Modell-Auto-Management — Speicherplatz-Tracking, LRU-Bereinigung ungenutzter Modelle", "NEU: Webhook-Benachrichtigungen — HTTP POST bei Job-Abschluss/Fehler", "NEU: Modell-Fallback-Kette — kommagetrennte Modelle, probiert nächstes bei Fehler", "NEU: 20+ neue Konfigurationsoptionen (Queue, Webhooks, Health, Modell-Management)", "FIX: processing_count wird bei Semaphore-Timeout nicht mehr negativ", "FIX: Blend-Gewichtung nutzt tatsächliche Inhaltsgröße statt gepaddte Tile-Größe", "FIX: Echtzeit-Modellauswahl war invertiert (2x für Echtzeit, 4x für Batch)", "FIX: Socket-Erschöpfung durch HttpClient pro Frame behoben"] },
    ...
    fr: {
        ...
        hero: {
            badge: "v1.5.4.0 — Video SR Multi-Trame",
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.4.0", date: "Mar 2026", type: "Major", items: ["NOUVEAU: SR vidéo multi-trame — fenêtre glissante avec EDVR-M, RealBasicVSR, AnimeSR v2", "NOUVEAU: Sélection automatique intelligente du modèle par vidéo (anime/live-action, résolution)", "NOUVEAU: Upscaling d'images pour affiches, arrière-plans, miniatures, logos, bannières", "NOUVEAU: File de traitement prioritaire avec pause/reprise, persistance, priorité 1-10", "NOUVEAU: Endpoint métriques Prometheus (/metrics) — jobs, erreurs, frames, timing par modèle", "NOUVEAU: Circuit breaker — s'ouvre automatiquement après échecs consécutifs", "NOUVEAU: Endpoint santé détaillé (/health/detailed) avec état GPU + circuit breaker", "NOUVEAU: Gestion auto des modèles — suivi espace disque, nettoyage LRU", "NOUVEAU: Notifications webhook — HTTP POST à la fin/échec d'un job", "NOUVEAU: Chaîne de fallback modèle — modèles séparés par virgule, essaie le suivant", "NOUVEAU: 20+ nouvelles options de configuration (queue, webhooks, santé, gestion modèles)", "CORR: processing_count ne devient plus négatif au timeout sémaphore", "CORR: Pondération du mélange utilise la taille réelle du contenu", "CORR: Sélection modèle temps réel inversée (2x pour temps réel, 4x pour batch)", "CORR: Épuisement des sockets HttpClient dans le traitement multi-trame"] },
    ...
    zh: {
        ...
        hero: { badge: "v1.5.4.0 — 多帧视频超分辨率", title1: "用人工智能", title2: "转换您的媒体。", subtitle: "使用神经网络将SD升级到4K。支持NVIDIA、AMD、Intel和Apple Silicon的GPU加速Docker微服务。", getStarted: "开始使用", viewGithub: "在GitHub上查看", stats: { gpus: "GPU架构", size: "插件大小", upscale: "升级", license: "开源" } },
    ...
    ru: {
        ...
        hero: { badge: "v1.5.4.0 — Многокадровое видео SR", title1: "Преобразуйте медиа", title2: "с помощью ИИ.", subtitle: "Масштабируйте SD до 4K с помощью нейросетей. GPU-ускоренный Docker-микросервис для Jellyfin.", getStarted: "Начать", viewGithub: "GitHub", stats: { gpus: "Архитектур GPU", size: "Размер плагина", upscale: "Масштабирование", license: "Open Source" } },
    ...
    ja: {
        ...
        hero: { badge: "v1.5.4.0 — マルチフレーム動画SR", title1: "AIでメディアを", title2: "変換する。", subtitle: "ニューラルネットワークでSDを4Kにアップスケール。NVIDIA、AMD、Intel、Apple Silicon対応のGPU対応Dockerマイクロサービス。", getStarted: "始める", viewGithub: "GitHub", stats: { gpus: "GPUアーキテクチャ", size: "プラグインサイズ", upscale: "アップスケール", license: "オープンソース" } },
