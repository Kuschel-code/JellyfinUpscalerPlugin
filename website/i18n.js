...
const i18n = {
    en: {
        ...
        hero: {
            badge: "v1.5.2.8 — 30+ Bug Fixes & Hardening",
        ...
        troubleshooting: {
            ...
            problems: [
                ...
                { title: "GPU Not Detected", desc: "Container runs in CPU mode despite GPU available.", solutions: ["NVIDIA: Install nvidia-container-toolkit, use --gpus all", "Intel: Use :docker4-intel tag with --device=/dev/dri", "AMD: Use :docker4-amd tag with --device=/dev/kfd --device=/dev/dri", "Windows: Use :docker4-cpu (GPU passthrough not supported in Docker Desktop)"], commands: [{ label: "Test NVIDIA", code: "docker run --rm --gpus all nvidia/cuda:12.2.2-base-ubuntu22.04 nvidia-smi" }, { label: "Test Intel", code: "docker exec jellyfin-ai-upscaler ls -la /dev/dri/" }] },
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.2.8", date: "Mar 2026", type: "Fix", items: ["30+ bug fixes: XSS hardening, race conditions, null refs, shell injection", "ApiClient guards on all Jellyfin API calls", "MutationObserver leak fix with lifecycle management", "Full dark theme hardening, custom CSS checkboxes", "Removed external Google Fonts dependency", "/gpus proxy endpoint, GPU_DEVICE_ID env var"] },
    ...
    de: {
        ...
        hero: {
            badge: "v1.5.2.8 — 30+ Bugfixes & Härtung",
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.2.8", date: "Mär 2026", type: "Fix", items: ["30+ Bugfixes: XSS-Härtung, Race Conditions, Null-Referenzen, Shell-Injection", "ApiClient-Guards für alle Jellyfin API-Aufrufe", "MutationObserver Leak-Fix mit Lifecycle-Management", "Vollständige Dark-Theme-Härtung, eigene CSS-Checkboxen", "Externe Google Fonts-Abhängigkeit entfernt", "/gpus Proxy-Endpunkt, GPU_DEVICE_ID Umgebungsvariable"] },
    ...
    fr: {
        ...
        hero: {
            badge: "v1.5.2.8 — 30+ Corrections & Renforcement",
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.2.8", date: "Mar 2026", type: "Correction", items: ["30+ corrections : renforcement XSS, conditions de course, références null, injection shell", "Guards ApiClient pour tous les appels API Jellyfin", "Correction fuite MutationObserver avec gestion du cycle de vie", "Renforcement complet du thème sombre, checkboxes CSS personnalisées", "Suppression de la dépendance Google Fonts externe", "Endpoint proxy /gpus, variable env GPU_DEVICE_ID"] },
    ...
    zh: {
        ...
        hero: { badge: "v1.5.2.8 — 30+修复与加固", title1: "用人工智能", title2: "转换您的媒体。", subtitle: "使用神经网络将SD升级到4K。支持NVIDIA、AMD、Intel和Apple Silicon的GPU加速Docker微服务。", getStarted: "开始使用", viewGithub: "在GitHub上查看", stats: { gpus: "GPU架构", size: "插件大小", upscale: "升级", license: "开源" } },
    ...
    ru: {
        ...
        hero: { badge: "v1.5.2.8 — 30+ исправлений и укрепление", title1: "Преобразуйте медиа", title2: "с помощью ИИ.", subtitle: "Масштабируйте SD до 4K с помощью нейросетей. GPU-ускоренный Docker-микросервис для Jellyfin.", getStarted: "Начать", viewGithub: "GitHub", stats: { gpus: "Архитектур GPU", size: "Размер плагина", upscale: "Масштабирование", license: "Open Source" } },
    ...
    ja: {
        ...
        hero: { badge: "v1.5.2.8 — 30+バグ修正と強化", title1: "AIでメディアを", title2: "変換する。", subtitle: "ニューラルネットワークでSDを4Kにアップスケール。NVIDIA、AMD、Intel、Apple Silicon対応のGPU対応Dockerマイクロサービス。", getStarted: "始める", viewGithub: "GitHub", stats: { gpus: "GPUアーキテクチャ", size: "プラグインサイズ", upscale: "アップスケール", license: "オープンソース" } },
