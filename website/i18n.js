...
const i18n = {
    en: {
        ...
        hero: {
            badge: "v1.5.2.2 — Security & Bug Fix",
    ...
    de: {
        ...
        hero: {
            badge: "v1.5.2.2 — Sicherheit & Bugfixes",
        ...
        changelog: {
            ...
            versions: [
                { ver: "1.5.2.2", date: "Mär 2026", type: "Fix", items: ["Behoben: Player Upscale-Button wurde nicht angezeigt (Issue #45)", "Globale Script-Injection in index.html (wie Intro Skipper)", "player-integration.js für Jellyfin 10.11+ SPA neu geschrieben", "Behoben: Intel OpenVINO GPU fiel auf CPU zurück", "Docker 1.5.4: Intel Compute-Runtime aktualisiert + GPU_FP32 Targeting"] },
    ...
    fr: {
        ...
        hero: {
            badge: "v1.5.2.2 — Sécurité & Corrections",
    ...
    zh: {
        ...
        hero: { badge: "v1.5.2.2 — 安全与修复", title1: "用人工智能", title2: "转换您的媒体。", subtitle: "使用神经网络将SD升级到4K。支持NVIDIA、AMD、Intel和Apple Silicon的GPU加速Docker微服务。", getStarted: "开始使用", viewGithub: "在GitHub上查看", stats: { gpus: "GPU架构", size: "插件大小", upscale: "升级", license: "开源" } },
    ...
    ru: {
        ...
        hero: { badge: "v1.5.2.2 — Безопасность и исправления", title1: "Преобразуйте медиа", title2: "с помощью ИИ.", subtitle: "Масштабируйте SD до 4K с помощью нейросетей. GPU-ускоренный Docker-микросервис для Jellyfin.", getStarted: "Начать", viewGithub: "GitHub", stats: { gpus: "Архитектур GPU", size: "Размер плагина", upscale: "Масштабирование", license: "Open Source" } },
    ...
    ja: {
        ...
        hero: { badge: "v1.5.2.2 — セキュリティとバグ修正", title1: "AIでメディアを", title2: "変換する。", subtitle: "ニューラルネットワークでSDを4Kにアップスケール。NVIDIA、AMD、Intel、Apple Silicon対応のGPU対応Dockerマイクロサービス。", getStarted: "始める", viewGithub: "GitHub", stats: { gpus: "GPUアーキテクチャ", size: "プラグインサイズ", upscale: "アップスケール", license: "オープンソース" } },
